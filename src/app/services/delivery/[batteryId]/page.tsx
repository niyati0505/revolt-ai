...
export default function DeliveryPage() {
  ...
  const trackingId =
    "RV-TRK-" + Math.floor(100000 + Math.random() * 900000);
    ...
    <main className="min-h-screen bg-[#071426] text-white p-8">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-3 text-slate-400">
          Arrange secure transportation for your reserved battery.
        </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-8 space-y-5">
              ...
              <Info
                ...
                value="REVOLT AI Logistics"
              />

              <Info
                icon={<Calendar size={20} />}
                title="Estimated Delivery"
                value={market.deliveryTime}
              />

              <Info
                icon={<PackageCheck size={20} />}
                title="Delivery Charges"
                value={market.deliveryCharge}
              />
